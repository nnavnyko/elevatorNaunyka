...
public class Controller {
	...
	public void initData() {
		...
		for (int i = 0; i < passengerNumber; i++) {
			...
			transportationTasks[i] = new Thread(new TransportationTask(passenger, this, logger, dispatchBuffers[story], elevatorBuffer));
	...
	protected void letPassengersIntoElevator() {
		...
		passengersToComeIn = dispatchContainers[curStory].passengersToGetIn(directionUp);
